...
class AssessmentController extends RController
{
        public $breadcrumbs;
    public $menu;
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Assessment']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->asid));
		}
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Assessment']))
		{
                       ...
                       if (!empty($model->asid)) $criteria->addCondition('asid = "'.$model->asid.'"');
                       ...
                       if (!empty($model->icd10code)) $criteria->addCondition('icd10code = "'.$model->icd10code.'"');
                 ...
                 $session['Assessment_records']=Assessment::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Assessment_records']))
               {
                $model=$session['Assessment_records'];
               }
               else
                 $model = Assessment::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->LastPage();
		$pdf->Output("Assessment_002.pdf", "I");
	}
}

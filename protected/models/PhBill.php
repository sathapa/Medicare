...
class PhBill extends CActiveRecord
{
	...
	public function search()
	{
		...
		return new CActiveDataProvider($this, array(
          ...
          public function ph($fromDate,$toDate){
    
                $qry = "SELECT round(sum(ph_bill.total),2) as ph, round(sum(reg_bill.total),2) as reg FROM `ph_bill` 
                        join
                        reg_bill on ph_bill.pid = reg_bill.pid where date between '$fromDate' and '$toDate'";

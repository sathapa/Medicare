...
class Patient extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title, fName, lName, dob, gender, marital_status, pStreet, pWardNo, pCity, pDistrict, pZone, country, guardianName, relation, mobilePhone, stat, clerk, date, time', 'required'),
            array('sStreet, sWardNo, sCity, sDistrict, sZone, motherName','safe'),
	...
	public static function model($className=__CLASS__)
	{
        ...
        public function listPatient($fromDate , $toDate, $gender){
           
            $qry = "select data_appointment.reason as complain, data_patient.* from data_patient join data_appointment on data_patient.id =data_appointment.id where data_patient.gender='$gender' and data_patient.date between '$fromDate' and '$toDate'";

...
// success, info, warning, error or danger
    ...
    <table class="table">
        ...
        <tr style="background-color: lavender">
            <th colspan="6"><i class="icon-user"></i>&nbsp;&nbsp;Basic Info</th>
        </tr>
        <tr>
            <td>Name</td>
        ...
        <tr style="background-color: lavender">
            <th colspan="6"><i class="icon-home"></i>&nbsp;&nbsp;Current Address</th>
        </tr>
        <tr>
            <td colspan="6"><?php echo $form->textFieldRow($model,'sStreet',array('class'=>'span2','maxlength'=>100)); ?>
                ...
                <?php echo $form->dropDownList($model,'sDistrict',CHtml::listData(Listaddress::model()->findAll(),'id','district'),
                    array('prompt'=>'Select District', 'class'=>'span2', 
                        'ajax'=>array(
                        'type'=>'POST',
...
//                    'update'=>'#'.CHtml::activeId($model,'sZone'),
        ...
        <tr style="background-color: lavender">
            <th colspan="6"><i class="icon-home"></i>&nbsp;&nbsp;Permanent Address</th>
        </tr>
        <tr>
...
//                    'update'=>'#'.CHtml::activeId($model,'sZone'),
        ...
        <tr style="background-color: lavender">
            <th colspan="6"><i class="icon-phone-sign"></i>&nbsp;&nbsp;Contact Information</th>
        </tr>
        <tr>
            <td>Mother's Name</td>

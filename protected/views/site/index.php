...
?>
    ...
    <?php
       ...
       // echo "Appointment.CREATE";var_dump(Yii::app()->user->checkAccess('Appointment.Create'));echo "<br>";
       // echo "Appointment.admin";var_dump(Yii::app()->user->checkAccess('Appointment.Admin'));echo "<br>";
       // echo "Employee.admin";var_dump(Yii::app()->user->checkAccess('Employee.Admin'));echo "<br>";
       // echo "Employee.create";var_dump(Yii::app()->user->checkAccess('Employee.Create'));echo "<br>";
       // echo "Patient.admin";var_dump(Yii::app()->user->checkAccess('Patient.Admin'));echo "<br>";
       // echo "Patient.create";var_dump(Yii::app()->user->checkAccess('Patient.Create'));echo "<br>";

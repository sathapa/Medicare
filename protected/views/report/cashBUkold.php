...
<table class="table table-striped table-bordered table-condensed">
 ...
 <form method="post" action="<?php echo Yii::app()->request->baseUrl; ?>/Report/GeneratePdf">
    <div style="float: left"><input type="submit" value="Generate Excel" /></div>
</form>

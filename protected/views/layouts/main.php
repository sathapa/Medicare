...
<head>
    ...
    <meta name="description" content="UB MediCARE">
    <title>UB MediCARE</title>
...
//                array('icon'=>'off','label'=>'Logout ('.Yii::app()->user->name.')', 'url'=>array('/site/logout'), 'visible'=>!Yii::app()->user->isGuest)
    array('label'=>'('.Yii::app()->user->name.')',
                    'items'=>array(
                      array('label'=>'User Profile', 'icon'=>'icon-user', 'url'=>array('/employee/update/'.Yii::app()->user->id)),
                      array('label'=>'Update Username/Password', 'icon'=>'icon-asterisk', 'url'=>array('/user/update/'.Yii::app()->user->id)),
            ...
            <div class="row">
                <div class="span12">
                    <ul>
                        ...
                        <li><a href="<?php echo CController::createUrl('/Discharge/listPatient'); ?>"><i class="icon-ok icon-white icon-2x"></i><br>Discharge</a></li>
...
<footer>
    <div class="container">
        <div class="row">
            <div class="span12">
                <p class="pull-right"><b>UB MediCARE</b></p>
                <p><b>UB</b></p>
            </div>
        </div>
    </div>

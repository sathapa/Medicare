...
$this->menu=array(
		array('label'=>'New Appointment', 'icon'=>'icon-plus', 'url'=>Yii::app()->controller->createUrl('create'), 'linkOptions'=>array()),
                array('label'=>'List Appointments', 'icon'=>'icon-th-list', 'url'=>Yii::app()->controller->createUrl('index'),'active'=>true, 'linkOptions'=>array()),
        ...
        array(
            ...
            'buttons' => array(
                ...
                'register' => array(
                    'label' => 'Register',
                    'icon' => 'icon-edit',
                    'url' => 'Yii::app()->controller->createUrl("Patient/create1",array("aid"=>$data->id))',
                    'options' => array(

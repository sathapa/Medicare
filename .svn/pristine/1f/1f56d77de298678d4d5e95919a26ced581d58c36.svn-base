...
$this->breadcrumbs=array(
	...
	$model->suid=>array('view','id'=>$model->suid),
	'Update',
);
...
<?php
$this->menu=array(
    array('icon'=>'plus-sign-alt','label'=>'Subjective', 'url'=>array('/Subjective/update','id'=>$_GET['id'])),
...
<!--<script language="javascript" type="text/javascript">
    function bmI()
    {
        ...
        document.getElementById('bmi').value = parseFloat(bm);
    }
</script>-->
...
<div class="form">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>BMI</td>
            <td><?php echo $form->textFieldRow($model,'bmi_calc',array('class'=>'span2','id'=>'bmi')); ?></td>
        </tr>
        <tr>
            <td>Tempr.</td>
        ...
        <tr style="display: none">
            <td colspan="6"><?php $session = Yii::app()->session;
                echo $form->textFieldRow($model,'pid',array('class'=>'span2')); ?>

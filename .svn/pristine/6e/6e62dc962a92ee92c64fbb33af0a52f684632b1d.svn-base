<?php  $form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
    ...
    'method' => 'get',
    'focus' => array($model,'cardID'),
));  ?>
<div style="padding-bottom: 5px; border-bottom: solid; border-bottom-width: thin; border-bottom-color: lightsteelblue">
    <?php echo $form->textFieldRow($model, 'cardID', array('class' => 'span3', 'maxlength' => 100)); ?>
</div>

<?php  $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
        'id'=>'search-ph-bill-identity-form',
	'action'=>Yii::app()->createUrl($this->route),
	'method'=>'get',
));  ?>


	<?php echo $form->textFieldRow($model,'phbiid',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'phid',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'phbid',array('class'=>'span5')); ?>
...
?>	
   <script>
	$(".btnreset").click(function(){
		$(":input","#search-ph-bill-identity-form").each(function() {
		var type = this.type;
